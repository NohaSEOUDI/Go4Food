...
public class Client {
    private static String cl_first_name;
    public String cl_last_name,cl_phone_number,cl_email_adress,cl_password;
    ...
    public static String getCl_first_name() {
        return cl_first_name;
    }
}
