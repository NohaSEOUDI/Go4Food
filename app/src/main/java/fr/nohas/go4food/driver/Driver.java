...
public class Driver {
    ...
    public int d_age;
    public TypeVehicule d_typeVehicule;
    public D_Planning d_dispo;
    public Boolean d_receve_delivery_commandes;

    public Driver(){  }

    public Driver(String d_nom, String d_prenom,String d_city, String d_adress, String d_adressmail, String d_numTel, String d_password, int d_age,TypeVehicule d_typeVehicule, D_Planning d_dispo,Boolean d_receve_delivery_commandes){
        this.d_nom=d_nom;
